...
def start_game():
    ...
    choice = input("Do you want to go north to the cottage? (yes/no): ")
    if choice.lower() == "yes":
        ...
        # if current_location.name == cottage:
        #     choice = input("Do you want to walk around the cottage or enter it? (walk/enter): ").lower()
        #     if choice == "walk":
        #         current_location.name = around_cottage
        #     elif choice == "enter":
        #         current_location = kitchen
        #     else:
        #         print("You stay outside the cottage.")
        ...
        #         current_location = kitchen
        #     else:
        #         print("You stay around the cottage.")
